...
public class AutoElytraRepair extends Module {
    ...
    private boolean wasAutoScoutActive = false;
    private int timer = 0;
    ...
    public AutoElytraRepair() {
        super(AutoScout.CATEGORY, "auto-elytra-repair", "Automatically repairs elytras when they get low on durability.");
    }
    ...
    private void initiateRepairSequence() {
        wasAutoScoutActive = ElytraController.isActive();
