...
public class AutoScoutModule extends Module {
    // Settings
    ...
    public AutoScoutModule() {
        super(AutoScout.CATEGORY, "Auto-Scout", "Automatically finds stashes by flying around and scanning for valuable blocks.");
    }
