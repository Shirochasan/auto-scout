package com.autoscout.autoscout.utils;
...
public class Config {
    private static final File CONFIG_FILE = new File(MeteorClient.FOLDER, "Auto-Scout.properties");
    ...
    public static void load() {
        if (CONFIG_FILE.exists()) {
            try (FileInputStream fis = new FileInputStream(CONFIG_FILE)) {
                ...
                System.err.println("Failed to load Auto-Scout config: " + e.getMessage());
                e.printStackTrace();
            }
        } else {
    ...
    public static void save() {
        try {
            ...
            try (FileOutputStream fos = new FileOutputStream(CONFIG_FILE)) {
                ...
                properties.store(fos, "Auto-Scout Configuration - Auto-generated");
            }
        } catch (IOException e) {
            System.err.println("Failed to save Auto-Scout config: " + e.getMessage());
            e.printStackTrace();
        }
    }
