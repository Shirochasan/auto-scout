...
- baritone 1.21.4
- fabric-api 0.119.4
- xaeroworldmap and xaerominimap 1.21.4
...
- **Customizable Commands**:
    - `.as`: The main command to configure the Auto-Scout module.
...
This document provides detailed instructions on how to use the commands available in the Auto-Scout addon.

### Main Command: `.as`

The `.as` command is the main command for controlling the automated flight and scanning system.

#### Sub-commands

-   `.as start <x1> <z1> <x2> <z2> [stripWidth]`
    ...
    -   **Example**:
        ```
        .as start ~-10000 ~-10000 ~10000 ~10000 200
        ```
...
-   `.as status`
    -   **Description**: Shows the current status of the Auto-Scout, including whether it's active, the current progress (waypoints), and the current target coordinates.
...
This document provides a detailed overview of all the settings available for customization in the Auto-Scout addon.
...
This document provides a detailed overview of the features available in the Auto-Scout addon.

### Auto-Scout Module

The `AutoScoutModule` is the core of this addon. It is a highly configurable module that automates the process of finding stashes.
...
The `AutoScoutHud` provides real-time information about the status of the Auto-Scout on your screen.
...
-   **shirochasan**: The author. Currently, [omtoi](https://github.com/omtoi101/Stash-Hunter)'s  Stash-Hunter was the base.
